...
const hungarySprite = new Image();
hungarySprite.src = "img/hungary.png";
...
function gameOver() {
	...
	ctx.fillText(`Your highest score was ${highScore} and you got to level ${level}`, 400, 300);
	ctx.fillStyle = "white";
	ctx.textAlign = "center";
	ctx.font = "20px 'Press Start 2P'";
	ctx.fillText("Press RESET to play again!", 400, 350);
	ctx.fillStyle = "white";
	ctx.textAlign = "center";	
}
...
function drawHungary(){
	ctx.drawImage(hungarySprite, 0,0,232,212,0,400,100,91);
}
